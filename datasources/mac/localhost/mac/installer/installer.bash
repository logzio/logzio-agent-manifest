...
# Copy Logz.io OTEL collector plist file to Library LaunchDaemons directory
sudo echo >/dev/null
execute_task 'copy_logzio_otel_collector_plist_file_to_library_launch_daemons_dir' 'Copying Logz.io OTEL collector plist file to Library LaunchDaemons directory'
